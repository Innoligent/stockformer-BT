...
class SAC(OffPolicyAlgorithm):
    ...
    def _state_transfer_predict(self, x):
        ...
        temporal_features = th.cat((temporal_feature_short, temporal_feature_long), dim=2)
