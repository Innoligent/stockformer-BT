...
class FeatureEngineer:
    ...
    def preprocess_data(self, df, type=0):
        ...
        #print('test 001')
        #print(self.use_technical_indicator, self.use_vix, self.use_turbulence, self.user_defined_feature)
        ...
        df = df.fillna(method="ffill").fillna(method="bfill")   #no fillna in pandas2.0
        ...
        for indicator in self.tech_indicator_list:
            ...
            for i in range(len(unique_ticker)):
                try:
                    ...
                    indicator_df = pd.concat([indicator_df, temp_indicator], ignore_index=True)   #no append object in pandas 2.0
